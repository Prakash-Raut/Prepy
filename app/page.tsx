      ...
      <header className="border-b">
        <div className="container flex items-center justify-between py-4">
          <div className="flex items-center gap-2">
            <div className="bg-gradient-to-r from-blue-600 to-blue-600 w-8 h-8 rounded-md" />
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signup">
              <Button size="sm" className="bg-gradient-to-r from-blue-600 to-blue-600 text-white">
                Sign up
              </Button>
            </Link>
          </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <Link href="/signup">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-blue-600 text-white">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col p-6 bg-gradient-to-b rounded-xl border border-blue-200 shadow-md relative">
              ...
              <Link href="/signup">
                <Button className="w-full bg-gradient-to-r from-blue-600 to-blue-600 text-white">
                  Get started
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-4 md:space-y-6 max-w-3xl mx-auto">
            ...
            <Link href="/signup">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-blue-600 text-white mt-4">
                Get started for free
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="bg-gradient-to-r from-blue-600 to-blue-600 w-8 h-8 rounded-md"></div>
                <span className="text-xl font-bold">Prepy</span>
              </div>
